...
## Step 4 – HTML Page Displaying Articles

Add a route that returns an HTML page displaying all the articles

This can be a simple endpoint that renders an HTML template with the articles data
...
* Focus on structure, logic, and explanation
